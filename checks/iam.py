...
class iam(object):
    ...
    def iam_1(self):
        ...
        results = {
            ...
            "remediation" : "Ensure contact email and telephone details for AWS accounts are current. This activity can only be performed via the AWS Console, with a user who has permission to read and write Billing information (aws-portal:*Billing ).",
            "impact" : "info",
            "probability" : "info",
            "cvss_vector" : "N/A",
            "cvss_score" : "N/A",
    ...
    def iam_2(self):
        ...
        results = {
            ...
            "remediation" : "Ensure security contact information is registered, Note: Consider specifying an internal email distribution list to ensure emails are regularly monitored by more than one individual.",
            "impact" : "info",
            "probability" : "info",
            "cvss_vector" : "N/A",
            "cvss_score" : "N/A",
    ...
    def iam_4(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure no root user account access key exists (CIS)",
            "affected": [],
    ...
    def iam_5(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure MFA is enabled for the root user account (CIS)",
            "affected": [],
    ...
    def iam_6(self):
        ...
        results = {
            ...
            "level" : 2,
            "service" : "iam",
            "name" : "Ensure hardware MFA is enabled for the root user account (CIS)",
            "affected": [],
    ...
    def iam_7(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Eliminate use of the 'root' user for administrative and daily tasks (CIS)",
            "affected": [],
            "analysis" : "",
        ...
        if password_last_used != "no_information":
            ...
            results["affected"].append(self.account_id)
            results["analysis"] = "There is currently no information on root account usage."
            results["pass_fail"] = "PASS"
    ...
    def iam_8(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure IAM password policy requires minimum length of 14 or greater (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_9(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure IAM password policy prevents password reuse (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_10(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure multi-factor authentication (MFA) is enabled for all IAM users that have a console password (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_12(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure credentials unused for 45 days or greater are disabled (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_13(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure there is only one active access key available for any single IAM user (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_14(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure access keys are rotated every 90 days or less (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_15(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure IAM Users Receive Permissions Only Through Groups (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_17(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure a support role has been created to manage incidents with AWS Support (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def iam_18(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "iam",
            "name" : "Ensure that all the expired SSL/TLS certificates stored in AWS IAM are removed (CIS)",
            "affected": [],
            "analysis" : "",
