...
class rds(object):
    ...
    def rds_1(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "rds",
            "name" : "Ensure that encryption is enabled for RDS Instances (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def rds_2(self):
        ...
        results = {
            ...
            "level" : "N/A",
            "service" : "rds",
            "name" : "RDS Instances Do Not Have Deletion Protection Enabled (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def rds_3(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "rds",
            "name" : "Ensure Auto Minor Version Upgrade feature is Enabled for RDS Instances (CIS)",
            "affected": [],
            "analysis" : "",
    ...
    def rds_4(self):
        ...
        results = {
            ...
            "level" : 1,
            "service" : "rds",
            "name" : "Ensure that public access is not given to RDS Instance (CIS)",
            "affected": [],
            "analysis" : "",
